...
>
  ...
  <div
    class="fixed bottom-2.5 left-3 right-auto items-center rounded-lg lg:inline-block lg:relative lg:left-0 lg:px-0 lg:rounded-none dark:text-white align-left"
  >
    <button
      x-ref="button"
      x-on:click="toggle()"
      ...
      type="button"
      class="flex z-40 flex-col py-0.5 px-2 font-serif text-sm rounded-lg lg:py-0 lg:bg-transparent lg:rounded-none all-small-caps backdrop-blur-xs bg-white/65 cursor-crosshair lg:underline-offset-2 lg:hover:underline lg:backdrop-filter-none dark:bg-white/25 dark:lg:bg-transparent">
      share this project
    </button>
