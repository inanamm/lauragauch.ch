<div class="dark:text-white relative h-full z-20 overflow-y-scroll no-scrollbar" x-data="drawer">
  ...
  <div class="h-screen w-full fixed inset-0" @click="toggleDrawer" x-show="drawerOpen"
       :aria-expanded="drawerOpen.toString()" style="display: none;">
  </div>
  ...
  <div class="fixed flex flex-col items-center bottom-2.5 lg:bottom-1 inset-x-20 font-serif text-base leading-tight">
    ...
    <button
      ...
      :aria-expanded="drawerOpen" aria-controls="navigation" class="
            hover:underline 
            underline-offset-2 
            all-small-caps 
            text-sm
