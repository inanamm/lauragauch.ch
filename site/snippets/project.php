<div class="relative h-full z-20 overflow-y-scroll" x-data="{ menuOpen: false }"
    ...
    <div class="fixed flex flex-col items-center bottom-1 inset-x-20 font-serif text-base ">
    ...
    <div id="navigation" x-show="menuOpen" x-ref="projectOverlay"
        class="w-full flex flex-col fixed bottom-0 top-[35%] left-0 backdrop-blur-md overflow-y-scroll rounded-t-2xl"
        ...
        <article class="top fixed grid lg:grid-cols-6 grid-row px-3 font-sans text-lg pb-20 gap-6">
            ...
            <div class="lg:row-start-1 row-start-2 lg:col-start-2 lg:col-end-6 text-lg pb-24 pt-2">
                <h2 id="project-title" class="text-lg text-center"></h2>
